...
```bash
venv/Scripts/python.exe scripts/extraer_texto_tesis.py           # volcamiento de .docx/.pdf/.htm a texto
...
- **En `04_normativa/` hay dos copias idénticas del modelo CACES 2024** (MD5 `41996f42`):
  `Modelo-generico-…-carreras-de-grado.pdf` and `modelo_caces_2024.pdf`. Sobra una.
