                  ...
                  <div>
                    ...
                    <div className="bg-slate-950/50 p-4 rounded-2xl border border-amber-500/30 shadow-inner">
                      ...
                      <p className="mt-3 text-xs text-slate-500 leading-relaxed">
                        Detectados sobre el PDF por coordenadas: la etiqueta existe en la plantilla y no tiene
                        nada escrito debajo. El porcentaje mide aparte los elementos de la estructura.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {task.resultado.checklist && task.resultado.checklist.length > 0 ? (
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 bg-slate-950/50 p-5 rounded-2xl border border-slate-800/80 leading-relaxed shadow-inner">
                      ...
                      oficial del indicador, no pertenece a la carrera, o no pudo leerse. No se llamó al modelo.
                    </p>
                  </div>
                )}
              </div>
